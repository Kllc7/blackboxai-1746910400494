...
function collectHeart(index) {
    ...
    // Play collect sound
    document.getElementById('collect-sound').play().catch(e => console.log('Audio play failed:', e));
...
function startGame() {
    ...
    document.getElementById('background-music').play().catch(e => console.log('Music play failed:', e));
}
